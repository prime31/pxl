...
render :: proc() {pxl.begin_pass(pxl.color_rgb(15, 15, 25)); for &b in game {pxl.rect(b.pos, pxl.Vec2{b.size, b.size}, b.color)}; for i in 0..<len(game) {for j in (i+1)..<len(game) {pxl.line(game[i].pos, game[j].pos, 0.5, pxl.color_rgba(100, 100, 140, 60))}}; pxl.text("FPS", pxl.Vec2{8, 8}, pxl.color_rgb(255, 255, 255)); pxl.end_pass()}
