...
void main() {
    ...
    vec3 sum = vec3(0.0);
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv + vec2(-2.0 * texel.x, 0.0)).rgb * 0.1216216;
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv + vec2(-1.0 * texel.x, 0.0)).rgb * 0.2332432;
...
void main() {
    ...
    vec3 sum = vec3(0.0);
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv + vec2(0.0, -2.0 * texel.y)).rgb * 0.1216216;
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv + vec2(0.0, -1.0 * texel.y)).rgb * 0.2332432;
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv).rgb * 0.2902703;
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv + vec2(0.0, 1.0 * texel.y)).rgb * 0.2332432;
    sum += texture(sampler2D(bloom_tex, bloom_smp), uv + vec2(0.0, 2.0 * texel.y)).rgb * 0.1216216;
